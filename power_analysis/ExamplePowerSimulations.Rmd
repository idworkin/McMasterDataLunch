...
### using a for loop
```{r mc_power, include = T, echo = T, eval = T}
...
```{r mc_power_loop, include = T, echo = T, eval = T}
...
power.b.t  <- t(power_b)  # Transpose the matrix to make it easier to work with.
dim(power.b.t)
