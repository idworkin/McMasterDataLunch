...
>- $\bar{x}_A$ is the mean for group $A$, $\bar{x}_A$ for $B$
...
```
>- This just uses one of the apply functions to repeat the function `pow.test` for each element of the vector "power". 
